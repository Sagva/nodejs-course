...
describe('Auth Controller - login', function() {
    ...
    before(function(done) { //if you execute async code in the function that passed into before you need to pass done to that function
    ...
    after(function(done) {//if the func execute async code don't forget to use done and call it in the end
